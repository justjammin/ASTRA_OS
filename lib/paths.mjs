...
export const REL = {
  ...
  plan: "PLAN.md",
  audit: "docs/audit.md",
  // `uiLayout` remains a read-only compatibility path for the visualizer. New Gate 1 runs
  // use `userStory`, which contains Mermaid plus the optional UI state map.
  userStory: "json/user-story.json",
  uiLayout: "json/ui-layout.json",
  userStoryFig: "designs/user-story.fig",
  userStoryPreview: "assets/user-story.png",
