...
export async function checkGate(root, gateId) {
  ...
  for (const spec of gate.artifacts) {
    ...
    const extra = spec.extra ? spec.extra(data) : { ok: true, detail: "schema ok" };
